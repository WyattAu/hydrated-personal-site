 ...
 */
export function quant_factor_regression(
  y: Float64Array,
  x: Float64Array,
  n_factors: number,
  n_obs: number,
...
export function update_ca_explorer(
  canvas_id: string,
  w: number,
  h: number,
  params_json: string,
...
export function update_gradient_descent(
  canvas_id: string,
  w: number,
  h: number,
  params_json: string,
...
export function update_lightning(
  canvas_id: string,
  w: number,
  h: number,
  params_json: string,
...
export function update_mandelbrot(
  canvas_id: string,
  w: number,
  h: number,
  params_json: string,
...
export function update_neural_net(
  canvas_id: string,
  w: number,
  h: number,
  params_json: string,
...
export function update_reaction_diffusion(
  canvas_id: string,
  w: number,
  h: number,
  params_json: string,
...
export function update_spectrogram(
  canvas_id: string,
  w: number,
  h: number,
  params_json: string,
...
export function update_trade_flow(
  canvas_id: string,
  w: number,
  h: number,
  params_json: string,
...
export function update_vol_surface(
  canvas_id: string,
  w: number,
  h: number,
  params_json: string,
...
export interface InitOutput {
  ...
  readonly create_gradient_descent: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly create_reaction_diffusion: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly quant_factor_regression: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly update_gradient_descent: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly update_reaction_diffusion: (
    a: number,
    b: number,
    c: number,
    d: number,
